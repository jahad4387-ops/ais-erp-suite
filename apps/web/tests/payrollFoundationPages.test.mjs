...
test("web app exposes Phase 4 payroll setup and calculation pages", () => {
  ...
  assert.match(appSource, /to="\/payroll-setup"/, "Payroll setup should be reachable from navigation.");
  assert.match(appSource, /to="\/payroll-runs"/, "Payroll runs should be reachable from navigation.");
