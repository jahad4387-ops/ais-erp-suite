...
test("web app exposes Phase 2 supplier and customer master data pages", () => {
  ...
  assert.match(navigationSource, /供应商档案/, "Navigation should expose supplier master data.");
  assert.match(navigationSource, /客户档案/, "Navigation should expose customer master data.");
