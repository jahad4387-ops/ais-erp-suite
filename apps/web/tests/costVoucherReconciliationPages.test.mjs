...
test("web app exposes Phase 3 cost voucher and inventory reconciliation pages", () => {
  ...
  assert.match(navigationSource, /to: '\/cost-voucher-drafts'/, "Cost voucher drafts should be reachable from navigation.");
  assert.match(navigationSource, /to: '\/inventory-reconciliation'/, "Inventory reconciliation should be reachable from navigation.");
